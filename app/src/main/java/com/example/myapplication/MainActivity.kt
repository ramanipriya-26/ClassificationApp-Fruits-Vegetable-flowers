...
import com.example.myapplication.ml.ModelUnquantf
...
class MainActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        /*val bufferReader = application.assets.open("labelf.txt").bufferedReader()
        val labels = bufferReader.use {
            it.readText()
        }*/
        val labels = application.assets.open("labelsf.txt").bufferedReader().use { it.readText() }.split("\n")
        //val labels={"daisy";"dandelion";"rose";"sunflower";"tulip"}
        ...
        make_prediction.setOnClickListener(View.OnClickListener {
            ...
            //val model = Modelf.newInstance(this)
            val model = ModelUnquantf.newInstance(this)
